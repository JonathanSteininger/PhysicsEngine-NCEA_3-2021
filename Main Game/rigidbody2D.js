class rigidBody {
  ...
  linebounceinteraction(i, pointsA, line1x1, line1y1, line1x2, line1y2, line2x1, line2y1, line2x2, line2y2, rba, tag) {
    let minPspeed = 2;
    let rb = JSON.parse(JSON.stringify(rba));
    if (collisionsbetweenline(line1x1, line1y1, line1x2, line1y2, line2x1, line2y1, line2x2, line2y2)) {
